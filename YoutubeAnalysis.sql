...
# Separate countries x continent, calculate a total amount of subs, uploads, views and earnings, group by the continent, order by total earnings and calculate the number of youtubers x continent.
/*SELECT
	-- Country,
	case
...
# 1b - PCT OF PAY PER CONTINENT
-- Put it in a temporary table pct_pay
/*With pct_pay as( 
SELECT
	-- Country,
	case
...
# 3 - TOP 8 CHANNELS TYPE, SUM OF VIEWS
/*SELECT 
channel_type,
